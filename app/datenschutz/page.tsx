  ...
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <p>
        ...
        whose contact information is available under the section “Information
      ...
      <p>
        ...
        provision of the website. Other data can be used to analyze your user
        patterns. If contracts can be concluded or initiated via the website,
        the transmitted data will also be processed for contract offers, orders
        or other service inquiries.
      </p>
      <p>
        <strong>
      ...
      <h2>2. Hosting</h2>
      <p>We host the content of our website at the following provider:</p>

      <h3>External Hosting</h3>
      <p>
        This website is hosted externally. Personal data collected on this
        website are stored on the servers of the host(s). These may include, but
        ...
        page access, and other data generated through a website.
      </p>
      <p>
        ...
        by a professional provider (Art. 6(1)(f) GDPR). If appropriate consent
        has been obtained, the processing is carried out exclusively on the
        basis of Art. 6(1)(a) GDPR and § 25(1) TDDDG, insofar as the consent
        includes the storage of cookies or access to information in the user’s
        terminal device (e.g. device fingerprinting) as defined by the TDDDG.
      ...
      <p>
        ...
        above-mentioned service. This is a contract mandated by data protection
      ...
      <p>
        ...
        identify you. This Privacy Policy explains which data we collect as well
      ...
      <p>
        ...
        request for deletion or revoke your consent to data processing, your data
      ...
      <p>
        ...
        categories of data are processed according to Art. 9(1) GDPR. In the case
        ...
        consented to the storage of cookies or to the access to information in
        your end device (e.g. via device fingerprinting), the data processing is
        additionally based on § 25(1) TDDDG. The consent can be revoked at any
        time. If your data is required for the fulfillment of a contract or for
        the implementation of pre-contractual measures, we process your data on
        the basis of Art. 6(1)(b) GDPR. Furthermore, if your data is required for
        the fulfillment of a legal obligation, we process it on the basis of Art.
        6(1)(c) GDPR. Furthermore, the data processing may be carried out based
        on our legitimate interest according to Art. 6(1)(f) GDPR. Information on
        the relevant legal basis in each individual case is provided in the
      ...
      <p>
        ...
        personal data to these external parties. We only share personal data with
        external parties if this is necessary in the context of contract
        fulfillment, if we are legally obligated to do so (e.g. sharing data with
        tax authorities), if we have a legitimate interest in the transfer
        according to Art. 6(1)(f) GDPR, or if another legal basis permits the
        sharing of this data. When using data processors, we only share personal
        data of our customers on the basis of a valid data processing agreement.
      ...
      <p>
        ...
        LEGAL BASIS, ON WHICH ANY PROCESSING OF DATA IS BASED, PLEASE CONSULT
        THIS PRIVACY POLICY. IF YOU LOG AN OBJECTION, WE WILL NO LONGER PROCESS
        YOUR AFFECTED PERSONAL DATA, UNLESS WE ARE IN A POSITION TO PRESENT
      ...
      <p>
        ...
        necessary for the optimization of the website (e.g. cookies for measuring
        the web audience) shall be stored on the basis of Art. 6(1)(f) GDPR,
        unless a different legal basis is cited. The operator of this website has
        a legitimate interest in the storage of necessary cookies to ensure the
